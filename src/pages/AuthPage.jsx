...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-triply/5 via-triply-teal/5 to-triply-accent/5 dark:from-dark-bg dark:via-dark-surface dark:to-dark-elevated relative">
      {/* Theme Toggle & Language Toggle - في أعلى اليمين */}
      <div className="absolute top-6 right-6 flex items-center gap-3">
        <button
          onClick={toggleLanguage}
          className="rounded-full px-3 py-2 text-sm font-semibold border border-triply-mint/60 dark:border-dark-border/60 bg-triply-mint/10 dark:bg-dark-elevated/60 text-triply-dark dark:text-dark-text-primary hover:bg-triply-mint/30 dark:hover:bg-dark-elevated/80 transition-colors"
          aria-label={
            ...
            {!isLogin && (
              <div>
                ...
                <div className="relative">
                  <svg
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-triply-slate/40 dark:text-dark-text-muted"
                    width="20"
                    height="20"
                    fill="currentColor"
                    viewBox="0 0 20 20"
