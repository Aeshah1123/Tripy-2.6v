...
export const getDestinations = (t) => ({
  london: {
    nameKey: 'aiAssistant.destinations.london.name',
    name: t('aiAssistant.destinations.london.name'),
    flag: '🇬🇧',
    descriptionKey: 'aiAssistant.destinations.london.description',
    description: t('aiAssistant.destinations.london.description'),
    image: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=800',
    features: t('aiAssistant.destinations.london.features', { returnObjects: true })
  },
  paris: {
    nameKey: 'aiAssistant.destinations.paris.name',
    name: t('aiAssistant.destinations.paris.name'),
    flag: '🇫🇷',
    descriptionKey: 'aiAssistant.destinations.paris.description',
    description: t('aiAssistant.destinations.paris.description'),
    image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800',
    features: t('aiAssistant.destinations.paris.features', { returnObjects: true })
  },
  egypt: {
    nameKey: 'aiAssistant.destinations.egypt.name',
    name: t('aiAssistant.destinations.egypt.name'),
    flag: '🇪🇬',
    descriptionKey: 'aiAssistant.destinations.egypt.description',
    description: t('aiAssistant.destinations.egypt.description'),
    image: 'https://images.unsplash.com/photo-1572252009286-268acec5ca0a?w=800',
    features: t('aiAssistant.destinations.egypt.features', { returnObjects: true })
  },
  turkey: {
    nameKey: 'aiAssistant.destinations.turkey.name',
    name: t('aiAssistant.destinations.turkey.name'),
    flag: '🇹🇷',
    descriptionKey: 'aiAssistant.destinations.turkey.description',
    description: t('aiAssistant.destinations.turkey.description'),
    image: 'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?w=800',
    features: t('aiAssistant.destinations.turkey.features', { returnObjects: true })
  },
  dubai: {
    nameKey: 'aiAssistant.destinations.dubai.name',
    name: t('aiAssistant.destinations.dubai.name'),
    flag: '🇦🇪',
    descriptionKey: 'aiAssistant.destinations.dubai.description',
    description: t('aiAssistant.destinations.dubai.description'),
    image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800',
    features: t('aiAssistant.destinations.dubai.features', { returnObjects: true })
  }
});
...
export const getQuizQuestions = (t) => {
  const questions = t('aiAssistant.questions', { returnObjects: true });
  
  // Scoring remains the same regardless of language
  const scoringData = [
    [ // Question 1
      { london: 30, paris: 15, egypt: 5, turkey: 10, dubai: 5 },
      { london: 15, paris: 30, egypt: 5, turkey: 15, dubai: 5 },
      { london: 5, paris: 5, egypt: 30, turkey: 15, dubai: 30 },
      { london: 10, paris: 15, egypt: 10, turkey: 30, dubai: 10 }
    ],
    [ // Question 2
      { london: 30, paris: 30, egypt: 15, turkey: 15, dubai: 10 },
      { london: 20, paris: 20, egypt: 30, turkey: 25, dubai: 10 },
      { london: 15, paris: 25, egypt: 5, turkey: 20, dubai: 30 },
      { london: 15, paris: 15, egypt: 10, turkey: 15, dubai: 30 }
    ],
    [ // Question 3
      { london: 5, paris: 5, egypt: 30, turkey: 25, dubai: 15 },
      { london: 20, paris: 20, egypt: 20, turkey: 25, dubai: 20 },
      { london: 25, paris: 25, egypt: 15, turkey: 20, dubai: 25 },
      { london: 25, paris: 30, egypt: 10, turkey: 15, dubai: 30 }
    ],
    [ // Question 4
      { london: 30, paris: 30, egypt: 5, turkey: 10, dubai: 15 },
      { london: 5, paris: 5, egypt: 30, turkey: 25, dubai: 25 },
      { london: 25, paris: 25, egypt: 10, turkey: 20, dubai: 30 },
      { london: 15, paris: 20, egypt: 25, turkey: 30, dubai: 15 }
    ],
    [ // Question 5
      { london: 30, paris: 30, egypt: 5, turkey: 15, dubai: 10 },
      { london: 5, paris: 5, egypt: 30, turkey: 30, dubai: 25 },
      { london: 20, paris: 20, egypt: 5, turkey: 15, dubai: 30 },
      { london: 20, paris: 20, egypt: 20, turkey: 30, dubai: 25 }
    ],
    [ // Question 6
      { london: 15, paris: 15, egypt: 10, turkey: 15, dubai: 30 },
      { london: 25, paris: 25, egypt: 20, turkey: 25, dubai: 20 },
      { london: 25, paris: 25, egypt: 30, turkey: 25, dubai: 15 },
      { london: 20, paris: 20, egypt: 30, turkey: 30, dubai: 10 }
    ],
    [ // Question 7
      { london: 20, paris: 15, egypt: 20, turkey: 25, dubai: 30 },
      { london: 25, paris: 30, egypt: 15, turkey: 25, dubai: 20 },
      { london: 25, paris: 25, egypt: 20, turkey: 25, dubai: 25 },
      { london: 25, paris: 25, egypt: 25, turkey: 20, dubai: 15 }
    ],
    [ // Question 8
      { london: 30, paris: 10, egypt: 15, turkey: 10, dubai: 25 },
      { london: 20, paris: 30, egypt: 15, turkey: 20, dubai: 20 },
      { london: 5, paris: 5, egypt: 30, turkey: 15, dubai: 30 },
      { london: 20, paris: 25, egypt: 20, turkey: 25, dubai: 20 }
    ],
    [ // Question 9
      { london: 25, paris: 30, egypt: 15, turkey: 20, dubai: 30 },
      { london: 20, paris: 20, egypt: 30, turkey: 30, dubai: 10 },
      { london: 25, paris: 20, egypt: 15, turkey: 20, dubai: 30 },
      { london: 15, paris: 10, egypt: 30, turkey: 25, dubai: 15 }
    ],
    [ // Question 10
      { london: 30, paris: 30, egypt: 25, turkey: 25, dubai: 15 },
      { london: 15, paris: 25, egypt: 20, turkey: 25, dubai: 30 },
      { london: 20, paris: 20, egypt: 30, turkey: 30, dubai: 20 },
      { london: 20, paris: 25, egypt: 10, turkey: 20, dubai: 30 }
    ]
  ];
  ...
  return questions.map((q, index) => ({
    ...
    options: q.options.map((optionText, optIndex) => ({
      text: optionText,
      scores: scoringData[index][optIndex]
    }))
  }));
};
...
// دالة حساب النتائج
export function calculateDestination(answers, translatedDestinations = destinations) {
  const scores = {
    london: 0,
    paris: 0,
    egypt: 0,
  ...
  return {
    ...
    scores,
    percentages,
    destinationData: translatedDestinations[topDestination]
  };
}
