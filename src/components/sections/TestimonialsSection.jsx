...
function TestimonialsSection() {
  ...
  return (
    <section
      id="testimonials"
      className="section-padding bg-triply-sand/20 dark:bg-dark-surface/30"
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 text-right">
        <div className="space-y-4 text-center">
          <span className="heading-gradient text-sm font-medium">
                  ...
                  <div className="glass-panel mx-auto max-w-3xl flex flex-col gap-6 p-8 md:p-10">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-semibold text-lg text-triply-dark dark:text-dark-text-primary">
                      ...
                      <svg
                        viewBox="0 0 24 24"
                        className="h-8 w-8 flex-shrink-0 text-triply-accent dark:text-triply-accentLight opacity-50"
                        fill="currentColor"
                        aria-hidden="true"
                      >
