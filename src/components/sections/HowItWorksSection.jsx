...
function HowItWorksSection() {
  ...
  return (
    <section
      id="how-it-works"
      className="section-padding relative bg-gradient-to-b from-white via-triply-mint/5 to-white dark:from-dark-bg dark:via-dark-surface/30 dark:to-dark-bg"
    >
      <div
      ...
      <div className="relative mx-auto max-w-6xl px-6 text-right">
        <div className="mb-12 space-y-4 text-center">
          <span className="heading-gradient text-xs sm:text-sm font-medium">
            {t("howItWorks.badge")}
          </span>
          ...
          {steps.map((step, index) => (
            <div
              ...
              className={`group relative ${
                visibleItems.has(index) ? "reveal-fade-up" : "reveal"
              }`}
            >
              {/* Connector line */}
