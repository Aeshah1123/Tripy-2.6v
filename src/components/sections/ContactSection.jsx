...
function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="section-padding relative overflow-hidden bg-gradient-to-b from-white via-triply-accent/10 to-white dark:from-dark-bg dark:via-dark-surface/30 dark:to-dark-bg"
    >
      {/* Decorative elements */}
      <div
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-6 text-right lg:grid-cols-[1.1fr,0.9fr] lg:gap-16">
        <div
          ref={infoRef}
          className={`space-y-6 ${
            infoVisible ? "reveal-fade-right" : "reveal"
          }`}
        >
          ...
          <div className="grid gap-5 pt-4">
            <div className="group flex items-start gap-4 p-5 rounded-2xl bg-white dark:bg-dark-elevated border-2 border-triply-mint/40 dark:border-dark-border/50 shadow-lg hover:shadow-xl dark:shadow-soft-dark dark:hover:shadow-ambient-dark transition-all duration-300 hover:-translate-y-1 hover:border-triply dark:hover:border-triply-mint">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-triply-dark dark:text-dark-text-primary mb-1 group-hover:text-triply dark:group-hover:text-triply-mint transition-colors">
                  {t("contact.emailTitle")}
                </h3>
                <a
                  className="text-triply-slate/80 dark:text-dark-text-secondary hover:text-triply dark:hover:text-triply-mint transition-colors"
                  href="mailto:iwq32j@gmail.com"
                >
                  iwq32j@gmail.com
                </a>
              </div>
            ...
            <div className="group flex items-start gap-4 p-5 rounded-2xl bg-white dark:bg-dark-elevated border-2 border-triply-mint/40 dark:border-dark-border/50 shadow-lg hover:shadow-xl dark:shadow-soft-dark dark:hover:shadow-ambient-dark transition-all duration-300 hover:-translate-y-1 hover:border-triply dark:hover:border-triply-mint">
              ...
              <div className="flex-1">
                ...
                <p className="text-triply-slate/80 dark:text-dark-text-secondary">
                  {t("contact.address")}
                </p>
              </div>
            </div>
        ...
        <form
          ...
          className={`relative overflow-hidden rounded-3xl border-2 border-triply-mint/40 dark:border-dark-border/50 bg-white dark:bg-dark-elevated shadow-2xl dark:shadow-ambient-dark p-8 sm:p-10 ${
            formVisible ? "reveal-fade-left" : "reveal"
          }`}
        >
          ...
          <div className="relative space-y-5">
            <div className="grid gap-5 md:grid-cols-2">
              <label className="flex flex-col gap-2.5 text-sm">
                <span className="font-semibold text-triply-dark dark:text-dark-text-primary flex items-center gap-2">
                  <svg
                    className="w-4 h-4 text-triply dark:text-triply-mint"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <input
                  ...
                  type="text"
                />
                <FormHelper text={t("contact.nameHelper")} />
              </label>
              ...
              <label className="flex flex-col gap-2.5 text-sm">
                ...
                <input
                  ...
                  type="email"
                />
                <FormHelper text={t("contact.emailHelper")} />
              </label>
            </div>
            ...
            <label className="flex flex-col gap-2.5 text-sm">
              ...
              />
              <FormHelper text={t("contact.messageHelper")} />
            </label>
            ...
            {status === "success" ? (
              ...
              >
                <svg
                  className="w-5 h-5 text-triply-teal dark:text-triply-mint flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
