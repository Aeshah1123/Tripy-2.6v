          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/30 dark:border-dark-border/50 bg-white/10 dark:bg-dark-surface/40 px-4 py-2 text-xs font-semibold backdrop-blur-sm">
                <svg
                  className="w-3.5 h-3.5 text-triply-mint"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
            ...
            <div>
              <h5 className="text-xs font-semibold text-white/60 dark:text-dark-text-secondary uppercase tracking-wide mb-3">
                {t("footer.followUs")}
              </h5>
            ...
            <ul className="space-y-3 text-sm">
              {resourceLinks.map((link) => (
                <li key={link.labelKey}>
                  <a
                    className="group inline-flex items-center gap-2 text-white/75 dark:text-dark-text-secondary transition-all hover:text-white dark:hover:text-dark-text-primary hover:translate-x-1"
                    href={link.href}
                  >
                    <svg
                      className="w-3.5 h-3.5 text-triply-mint dark:text-triply-teal opacity-0 group-hover:opacity-100 transition-opacity"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3 text-white/75 dark:text-dark-text-secondary group">
                <svg
                  className="w-5 h-5 text-triply-mint dark:text-triply-teal flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
        ...
        <div className="flex flex-col gap-4 border-t-2 border-white/10 dark:border-dark-border/30 pt-8 text-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <p className="text-white/70 dark:text-dark-text-secondary flex items-center gap-2">
              ...
              © {new Date().getFullYear()} Triply. {t("footer.copyright")}
            </p>
            <p className="text-white/70 dark:text-dark-text-secondary flex items-center gap-2">
              {t("footer.madeWith")}
